...
### ++Tài khoản chưa được thêm vào dự án GitHub++
...
### ++Item không xuất hiện hoặc sai thứ tự++
...
### ++Giá trị No trên MoMorph không đúng++
...
### ++Mất spec sau khi thay frame Figma++
...
### ++AI generation bị dừng giữa chừng++
...
- Hoặc có thể khi bạn cài đặt MoMorph Syncer chưa cấp đủ quyền cho ứng dụng tương tác với dữ liệu của bạn. Vui lòng gỡ và cài đặt lại [MoMorph Syncer](https://workspace.google.com/marketplace/app/momorph_syncer/227419153527).

### ++Lỗi khi export spec sang GitHub++
...
### ++Best practice thiết kế Figma cho AI++
...
### ++Quy tắc đặt tên item (mms* / id*)++

**❓ Q:** Cách đặt tên item để MoMorph nhận diện là gì, và khi nào thì tên cũ 'id' ngừng được hỗ trợ?
...
### ++Workflow tạo code: MoMorph vs Takumi kit++
